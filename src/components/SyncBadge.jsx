...
export default function SyncBadge({ status }) {
  ...
  if (!cfg) return null;
  return (
    <div className="hidden lg:flex" style={{position:'fixed',top:62,right:8,zIndex:9999,background:cfg.bg,color:'#fff',borderRadius:20,padding:'4px 12px',fontSize:12,fontWeight:600,alignItems:'center',gap:4,boxShadow:'0 2px 8px rgba(0,0,0,0.2)'}}>
