    ...
    <div className="flex flex-col gap-5">
      ...
      {plan === 'free' && (
        <Card className="px-5 py-4 flex flex-col gap-3">
          ...
          {atAnyLimit ? (
            <div className="rounded-xl border border-red-200 px-4 py-3 flex flex-col gap-2.5" style={{background:'rgba(239,68,68,0.05)'}}>
              <p className="text-xs font-semibold text-red-700">Limite atingido — novos registros bloqueados</p>
              <p className="text-xs text-gray-500 leading-relaxed">Para continuar registrando, entre em contato e ative o plano Pro.</p>
              <a href="https://wa.me/5591992086829?text=Quero%20ativar%20o%20plano%20Pro%20do%20Financia"
                target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-xs font-semibold text-white px-4 py-2.5 rounded-xl w-fit min-h-[44px]"
                ...
                Falar no WhatsApp — (91) 99208-6829
              </a>
            </div>
          ) : (
